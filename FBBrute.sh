...
printf "$Goke""\nESTE SCRIPT ESTÁ HECHO CON FINES EDUCATIVOS, NO ME HAGO RESPONSABLE DEL MAL USO QUE HAGAN DE ESTA HERRAMIENTA\n."

printf "$Amarillo""\nSCRIPT CREADO POR: "$Magenta"CiberDark888\n"

printf "$Goke""\nACONTINUACIÓN INICIE SESIÓN CON SU CUENTA DE FABOOK PARA VERIFICAR QUE NO ERES UN ROBOT:\n\n\n"
